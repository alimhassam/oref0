...
function defaults ( ) {
  var profile = {
    ...
    , carbratio_adjustmentratio: 1 // if carb ratios are set lower then needed, 1.2 = will increase the carb ration by 20%.
...
function generate (inputs, opts) {
  ...
  if (profile.carbratio_adjustmentratio && profile.carbratio_adjustmentratio < 1) {
    console.error("Profile carbratio adjustment is dangerous when autotune or smb, flooring it to 1");
    profile.carbratio_adjustmentratio = 1;
  }
  return profile;
}
